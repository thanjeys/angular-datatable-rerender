...
import { StoremangersService } from '../../services/storemangers.service';
...
@Component({
  selector: 'app-storemanagers',
  templateUrl: './storemanagers.component.html',
  styleUrls: ['./storemanagers.component.css']
})
export class StoremanagersComponent implements OnInit {
  ...
  constructor(
    ...
    private StoremangersService:StoremangersService,
  ...
  getData(currentPage, perPage):void{
    ...
    this.StoremangersService.GetStoremanagers(params)
